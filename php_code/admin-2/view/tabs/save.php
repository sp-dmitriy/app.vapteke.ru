<?php
    ...
    if( $_SESSION['user'] != "demo@admin.com" ){
        ...
        if($id == null){
            $record = "INSERT INTO `tabs` VALUES(NULL,'".$title."','".$image."','".$url."','".$status."')";
            $message = "Tab has been saved successfully";
            ...
            $record = "UPDATE `tabs` SET `title` = '$title', `url` = '$url', `image` = '$image' , `status` = '$status' WHERE `id` = '".$id."' ";
    ...
    header("Location: ../../view/index.php?page=tabs");
?>