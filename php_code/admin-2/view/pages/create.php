            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="new-user-info">
                        <form method="post"  action="./pages/save.php" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="url" class="form-control" name="url" id="url" value ="<?= isset($row) && isset($row['url']) ? $row['url'] : '' ?>" placeholder="Enter URL" required>
                                </div>
                                <div class="form-group col-md-6">
